<%-- 
    ...
    Created on : Nov 30, 2017, 7:54:39 PM
    Author     : tienpv
--%>
                    ...
                    <div class="product-details"><!--product-details-->
                        <div class="col-sm-5">
                            <div class="view-product">
                                <img src="${pageContext.request.contextPath}/${fn:escapeXml(product.imgLink)}" alt="" />
                                <h3>ZOOM</h3>
                            </div>
                        ...
                        <div class="col-sm-7">
                            <div class="product-information"><!--/product-information-->
                                ...
                                <p>Web ID: ${fn:escapeXml(product.productId)}</p>
                                <img src="${pageContext.request.contextPath}/resources/images/product-details/rating.png" alt="" /><br>
                                <span>
                                    <span>${fn:escapeXml(product.price)}<sup>VNĐ</sup></span><br>
